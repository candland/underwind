...
<head>
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=UA-46540000-1"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-46540000-1');
  </script>
</head>
	...
	<header id="masthead" class="site-header container mx-auto p-4 flex flex-row flex-wrap justify-between">
		<div class="site-branding flex-initial">
			...
			if ( $underwind_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $underwind_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
